...
- The app has three user modes: `Timer`, `Plan`, and `Body`.
- Settings are opened from global app chrome, not from inside Timer, Plan, or Body cards.
...
- Settings includes app data import/export for app-owned `localStorage`; keep destructive data actions explicit and confirmed.
